...
Execute unit tests
```
    cd "Monitoring.AWS.Lambda.Monitoring/test/Monitoring.AWS.Lambda.Monitoring.Tests"
    dotnet test
```

Deploy application
```
    cd "Monitoring.AWS.Lambda.Monitoring/src/Monitoring.AWS.Lambda.Monitoring"
