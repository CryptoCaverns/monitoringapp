...
Execute unit tests
```
    cd "Monitoring.AWS.Lambda.MonitoringJobStats/test/Monitoring.AWS.Lambda.MonitoringJobStats.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Monitoring.AWS.Lambda.MonitoringJobStats/src/Monitoring.AWS.Lambda.MonitoringJobStats"
