...
Execute unit tests
```
    cd "Monitoring.AWS.Lambda.RomProcessor/test/Monitoring.AWS.Lambda.RomProcessor.Tests"
    dotnet test
```

Deploy application
```
    cd "Monitoring.AWS.Lambda.RomProcessor/src/Monitoring.AWS.Lambda.RomProcessor"
